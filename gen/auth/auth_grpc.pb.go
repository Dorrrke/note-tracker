...
func (c *authServiceClient) Login(ctx context.Context, in *UserCredentials, opts ...grpc.CallOption) (*AuthResponse, error) {
...
func (UnimplementedAuthServiceServer) Login(context.Context, *UserCredentials) (*AuthResponse, error) {
